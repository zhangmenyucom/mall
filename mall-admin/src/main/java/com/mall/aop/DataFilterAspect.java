...
import com.mall.annotation.DataFilter;
import com.mall.entity.SellerEntity;
import com.mall.service.SysRoleDeptService;
...
public class DataFilterAspect {
     ...
     * 切点
     */
    @Pointcut("@annotation(com.mall.annotation.DataFilter)")
     ...
     * @return sql
     */
    private String getFilterSQL(SellerEntity user, JoinPoint point) {
