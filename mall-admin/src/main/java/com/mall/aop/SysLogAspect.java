...
import com.mall.utils.HttpContextUtils;
import com.mall.utils.IPUtils;
...
public class SysLogAspect {
     ...
     * 切点
     */
    @Pointcut("@annotation(com.mall.annotation.SysLog)")
    ...
    public void saveSysLog(JoinPoint joinPoint) {
        ...
        //用户名
        SellerEntity sysUserEntity = ShiroUtils.getUserEntity();
        String username = "";
